...
## **ZIP伪加密**
zip没有加密但也要你输入密码，此时010打开手动修复，如果第一部分504B0304的第7和第8对都是00 00，或0偶数 00，则本身没有密码。修改第二部分的所有504B0102后的第9和第10对都是0000 或0偶数00，则不会提示密码了。当然所有504B0304后的第7和第8对也要都是00 00。如果不修复解压的数据会错误。
...
![](.topwrite/assets/image_1735220206254.png)
